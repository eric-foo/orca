...
- **Open `docs/research/judgment-spine/judgment_spine_consolidation_map_v0.md` first** for any Judgment Spine work; it routes to the ladder, gate ownership map, conductor, JSG-08 owner contract, and Level 1 core-minimum route below.
- `docs/product/judgment_spine/judgment_level1_product_learning_core_minimum_v0.md` when the work is Level 1 backtesting-first product learning: commission gate, source registry, outcome labels, forecast/action/log/evaluation artifacts, satellite fill, or fragrance backtest setup.
