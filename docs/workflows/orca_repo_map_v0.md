...
- Latest focused addition: 2026-06-30 (`docs/workflows/ig_youtube_behavioral_e2e_closeout_receipt_v0.md` records the evidence-first IG/YT behavioral closeout: canonical F-lake IG has 12 complete, 2 complete-with-residuals, and 5 no-eligible-source items; a bounded canonical YouTube F-lake caption-route e2e set now has two complete projections from watch packets, caption packets, and labeled operator product-mention records; platform-wide completeness is still not claimed).
