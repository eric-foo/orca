...
| `docs/workflows/ig_youtube_behavioral_e2e_closeout_receipt_v0.md` | Evidence-first IG/YT behavioral closeout receipt: canonical F-lake IG projection matrix, initial two-video bounded YouTube F-lake e2e evidence, and non-claims. For expanded YouTube corpus measurement, open `docs/workflows/youtube_behavioral_measurement_corpus_receipt_v0.md`. |
