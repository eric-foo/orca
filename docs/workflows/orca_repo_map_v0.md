...
| `docs/migration/commission_signal_board_migration_inventory_v0.md` | Inventory-only CSB marking artifact: current CSB-owned surfaces, legacy `commission gate` wording risks, consumed Product Lead/Search/Capture/Judgment/ECR/SCR/Cleaning surfaces, proposed future allocation, pilot dependency, owner questions, migration order, and non-claims. |
