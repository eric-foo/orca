...
| Check logical data-lake mechanics from capture through projection, ECR/Signal Statement Record, Cleaning, and Judgment | `docs/product/core_spine/core_spine_v0_data_lake_mechanics_map_v0.md` |
...
- summary: Planning-only logical mechanics map for how raw
  ...
  projection, ECR/Signal Statement Record, Cleaning, and Judgment flow by key without selecting
