...
open_next:
  - docs/product/data_capture_spine/core_spine_v0_data_capture_spine_obligation_contract_v0.md   # v0 = commissioned-capture only (the gap)
  ...
  - docs/product/data_capture_spine/demand_durability_indicator_capture_deconfliction_note_v0.md # the four profiles + this consequence
  - docs/product/product_lead/orca_buyer_proof_packet_v0.md                                       # never-a-feed invariant + monitoring-only kill
stale_if:
