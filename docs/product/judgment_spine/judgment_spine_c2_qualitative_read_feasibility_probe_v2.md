...
open_next:
  - docs/product/judgment_spine/judgment_spine_c2_qualitative_read_feasibility_probe_v1.md  # v1 + its graded result (provenance)
  - docs/product/judgment_spine/judgment_spine_c2_ledger_read_contract_v0.md                # the spec this informs (F4 → consistency/auditability requirement)
stale_if:
