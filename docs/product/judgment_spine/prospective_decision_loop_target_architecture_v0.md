...
orca_start_preflight:
  ...
  target_scope:
    - docs/product/judgment_spine/prospective_decision_loop_target_architecture_v0.md (new, this file only)
...
direction_change_propagation:
  ...
  downstream_surfaces_checked:
    - docs/product/judgment_spine/judgment_spine_evidence_ladder_architecture_v0.md  # consumed, not amended; no prospective path is claimed cleared
    - docs/product/judgment_spine/conductor_construction_integrity_probe_addendum_v1.md  # firewall translated, not edited; PROPOSED status respected
