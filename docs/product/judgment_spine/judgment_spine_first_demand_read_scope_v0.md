...
open_next:
  - docs/product/judgment_spine/judgment_spine_demand_read_machinery_architecture_v0.md  # the C0–C4 core being run
  - docs/product/judgment_spine/judgment_spine_c2_ledger_read_contract_v0.md             # C2 (Weight) contract
  - docs/product/judgment_spine/judgment_spine_c3_verdict_action_ceiling_contract_v0.md  # C3 (Verdict + Ceiling) contract
