...
open_next:
  - docs/product/source_capture_toolbox/source_capture_playbook_v0.md   # the capture method (human-rate, blocked-is-a-hypothesis, availability != body)
  - docs/product/source_capture_toolbox/capture_recon_index_v0.md       # per-source recon; archive availability != body pattern
stale_if:
