...
orca_start_preflight:
  ...
  target_scope:
    - docs/product/source_capture_toolbox/cloakbrowser_packet_runner_architecture_independent_pass_v0.md
...
- `docs/product/source_capture_toolbox/cloakbrowser_packet_runner_architecture_v0.md` (the prior pass).
...
Parallel edits at implementation time: `docs/product/source_capture_toolbox/README.md`
