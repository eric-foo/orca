...
open_next:
  - docs/product/source_capture_toolbox/pipe_block_wall_escalation_v0.md
  - docs/product/source_capture_toolbox/armory_weapon_and_pipe_readme_templates_v0.md
  - docs/product/source_capture_toolbox/source_capture_anti_block_ladder_usage_guide_v0.md
stale_if:
