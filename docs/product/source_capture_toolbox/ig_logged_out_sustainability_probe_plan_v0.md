...
- `docs/product/source_capture_toolbox/source_capture_playbook_v0.md`: access-control gate, blocked-as-hypothesis rule, receipt/verdict discipline.
...
- `docs/product/source_capture_toolbox/ig_capture_findings_consolidated_v0.md`: logged-out reachability and session-lane retirement for current IG signal.
- `docs/product/source_capture_toolbox/ig_r_probe_results_v0.md`: first measured pace-bound R evidence and open residuals.
- `docs/product/source_capture_toolbox/ig_capture_rate_findings_report_v0.md`: preliminary operating guidance and pending at-pace daily ceiling.
- `docs/product/source_capture_toolbox/ig_at_scale_operating_envelope_v0.md`: two-lane serious-v0 operating posture for 1,000 creators.
- `docs/product/source_capture_toolbox/ig_sustained_cadence_r_probe_design_v0.md`: prior R-probe design, purity boundary, and owner-gated run posture.
