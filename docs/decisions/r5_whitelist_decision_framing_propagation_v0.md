...
- **AR-02** (route-out representativeness) — **owner-deferred**: a route-out-rate accounting flag was added; the lane-downgrade-on-route-out-domination policy is an owner decision.
