...
- Source basis: current owner direction, `docs/decisions/turn_08_product_thesis_v0.md`, `docs/product/core_spine_v0_product_contract.md`, `orca/product/shared/engagement_registry/engagement_logic_registry_v0.md`, `docs/product/core_spine_v0_information_production_foundation_v0.md`
