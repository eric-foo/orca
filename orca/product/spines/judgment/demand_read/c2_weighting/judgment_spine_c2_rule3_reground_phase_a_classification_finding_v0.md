...
open_next:
  - orca/product/spines/foundation/demand_read_taxonomy/orca_demand_read_taxonomy_v0.md                            # main's two-axis demand-state model (the doctrine to re-ground onto)
  - orca/product/spines/judgment/demand_read/c2_weighting/judgment_spine_c2_ledger_read_contract_v0.md             # the live C2 read-contract (rules 1-2 landed; rule 3 OPEN) — ledger-c2-read-contract-v0 lane @ 6a04612e
  ...
  - orca/product/spines/judgment/demand_read/core/judgment_spine_demand_read_machinery_architecture_v0.md  # C0-C4 core; C2=Weight; C3=verdict+ceiling — judgment-spine-read-machinery-architecture-v0 lane @ 57339ea5
stale_if:
...
- `origin/main:orca/product/spines/foundation/demand_read_taxonomy/orca_demand_read_taxonomy_v0.md` — the
