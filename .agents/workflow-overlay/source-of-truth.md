...
- `docs/decisions/orca_product_thesis_consumer_demand_v0.md`: current Orca product thesis and value proposition (owner-ratified 2026-06-12; supersedes `docs/decisions/turn_08_product_thesis_v0.md`, retained as history).
