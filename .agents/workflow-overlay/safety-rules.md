...
- Do not edit installed global skills, user-level skills, plugin cache files, or future workflow-kernel source unless a later turn explicitly authorizes it.
